...
function PeopleDirectory() {
  ...
  useEffect(() => {
    const fetchPeople = async () => {
      try {
        ...
        const url = `https://mongodb-2-mcp4.onrender.com/api/users${
  ...
  const filteredPeople = displayedPeople.filter((person) => {
    ...
    const teams =
      (typeof person.teams === "string" ? person.teams.toLowerCase() : "") ||
      "";
  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-lg">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex relative">
          ...
          <div className="relative">
            ...
            <div
              id="filterSection"
              className={`absolute top-full right-0 mt-2 p-4 w-64 border border-gray-300 bg-white shadow-lg z-50 ${
            ...
            >
              ...
              >
                ...
                <i
                  className={`fa ${
                    showRoles ? "fa-chevron-up" : "fa-chevron-down"
                  }`}
                  aria-hidden="true"
                ></i>
              </div>
              ...
              <button
                className={`w-full p-1 mt-3 rounded ${
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div
          className={`flex-1 ${
            expandedPerson ? "w-1/6" : "w-full"
          } transition-all duration-300`}
        >
          <table
            className={`min-w-full bg-white border rounded-lg ${
              expandedPerson ? "w-full" : "w-full"
            }`}
          >
            <thead>
              <tr>
        ...
        {expandedPerson && (
          <div className="flex-1 w-[60%] md:w-5/6 ml-4 p-3 rounded-lg shadow-lg transition-all duration-300">
            <div className="flex bg-custom-blue p-4 mb-4 relative color">
              ...
              <img
                src={`https://i.pravatar.cc/40?img=${expandedPerson.name}`} // Match the table row image size
            ...
            <div>
              ...
              <p className="text-xs pl-2 w-[500px]">
                Al, IoT based real time condition monitoring of Electrical
